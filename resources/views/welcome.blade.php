    ...
    <main class="main">
        ...
        <section class="sec about" id="about">
            <div class="container">
                ...
                <div class="sec-txt">
                    <p>Научно-Производственная компания «РВТС» – разработчик умных систем учёта энергоресурсов (smart meter) и других отраслевых проектов в области Интернета вещей (IoT). Мы поставляем цифровые решения для крупнейших российских и зарубежных заказчиков, гибко подстраиваясь под их технологическую базу.</p>
                    <p>Среди наших клиентов производственные предприятия, застройщики,  ресурсопоставляющие организации, водоканалы, тепло- и  электросети, управляющие компании в сфере ЖКХ и недвижимости, органы муниципальной и федеральной власти.</p>
                </div>
            </div>
        </section>
        <section class="technologies" id="technologies">
            <div class="container">
                ...
                <div class="sec-txt">
                    <p>Применение наиболее современных технологий в сочетании с комплексным подходом к решению каждой конкретной задачи позволяет НПК «РВТС» предлагать наиболее эффективные решения. Мы открыты для обмена опытом и готовы к взаимовыгодному сотрудничеству.</p>
                </div>
        ...
        <section class="team" id="team">
            <div class="container">
                ...
                <div class="sec-txt">
                    <p>Попасть в команду НПК «РВТС» не просто. Для этого нужно жить высокими технологиями и постоянно совершенствоваться в своей профессиональной сфере.</p>
                    <p>Наша команда – более сотни сотрудников с высокой квалификацией. Инженеры, программисты, проектировщики, управленцы и другие специалисты  – уникальный коллектив, привыкший решать самые сложные и нестандартные задачи.</p>
                </div>
            </div>
        </section>
